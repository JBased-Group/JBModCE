...
void UpdateQueryCache( void )
{
	...
	ParallelProcess(workList, N_WAYS_TO_SPLIT_CACHE_UPDATE, ProcessQueryCacheUpdate, PreUpdateQueryCache, PostUpdateQueryCache, (sv_disable_querycache.GetBool()) ? 0 : 1);

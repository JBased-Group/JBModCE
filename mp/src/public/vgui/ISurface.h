...
public:
	...
	inline void GetFullscreenViewport(int& x, int& y, int& w, int& h)
	{
		GetWorkspaceBounds(x, y, w, h);
	}
	inline void PushFullscreenViewport()
	{
		
	}
	inline void PopFullscreenViewport()
	{

	}
	inline void SetSoftwareCursor(bool val)
	{
